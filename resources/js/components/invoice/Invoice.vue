                ...
                <div class="invoice-box" v-loading="loading">
                    <div class="container">
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                <tr class="item" v-for="(item, index) in invoice_data.shipment" :key="index">
                                    ...
                                    <td style="text-align: left;">{{ item.sender_address }} <br>
                                    <td style="text-align: left;">{{ item.client_address }} <br>
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            <tfoot>
                                <tr>
                                    <td colspan="4" right><b>Sub Total</b></td>
                                    <td colspan="2"><b>KES {{ invoice_data.count['sub_total'] }}</b></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><b>KES {{ invoice_data.count['total'] }}</b></td>
                                </tr>
                            </tfoot>
                        </table>
                        <v-divider></v-divider>
